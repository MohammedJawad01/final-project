...
class Room(models.Model):
    ...
    pricing_per_hour = models.DecimalField(max_digits=10, decimal_places=2, null=False)
...
class UserReservationHistory(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, null=False, related_name='reservation_history')
